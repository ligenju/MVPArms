...
import com.example.mvparms.mvp.model.api.ApiUrl;
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(ApiUrl.APP_DOMAIN)
...
//                    okHttpBuilder.sslSocketFactory(); //支持 Https, 详情请百度
                    ...
                    RetrofitUrlManager.getInstance().putDomain("model", URLManager.getInstance().getModelUrl());
                })
